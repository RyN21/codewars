...
# The directions were "NORTH", "SOUTH", "WEST", "EAST". Clearly "NORTH" and "SOUTH" are
...
# directly opposite but they become directly opposite after the reduction of "EAST" and "WEST"
...
# "NORTH" and "WEST", "WEST" and "SOUTH", "SOUTH" and "EAST" are not directly opposite of
# each other and can't become such. Hence the result path is itself : ["NORTH", "WEST", "SOUTH", "EAST"].
