...
require_relative '../lib/4kyu/sum_by_factors'
...
# The final result has to be given as a string in Java, C#, C, C++ and as an
# array of arrays in other languages.
